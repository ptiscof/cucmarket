# Generated by Django 2.2.13 on 2023-05-22 06:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('books_brief', models.TextField(blank=True, max_length=500, null=True, verbose_name='书籍简短描述')),
                ('books_front_image', models.ImageField(blank=True, null=True, upload_to='media/books/images', verbose_name='封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='books_market.Book', verbose_name='书籍')),
                ('cid', models.ForeignKey(on_delete=models.SET(0), to='books_market.Category', verbose_name='类别')),
            ],
        ),
        migrations.AddField(
            model_name='book',
            name='cid',
            field=models.ManyToManyField(through='books_market.Book_Category', to='books_market.Category'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('picture', models.ImageField(blank=True, null=True, upload_to='media/users/images', verbose_name='用户头像')),
